...
#import "MBProgressHUD+CL.h"

BOOL HUDAnimated = NO;

NSTimeInterval delay = 2;

@implementation MBProgressHUD (CL)
...
+ (MBProgressHUD*)showWhiteLoadingWithMessage:(NSString*)message toView:(UIView*)view
{
    ...
    [self showAnimatedWithImage:[UIImage imageNamed:@"MBProgressHUD.bundle/loading_white"] toHUD:hud];
    //hud
...
+ (MBProgressHUD*)showGaryLoadingWithMessage:(NSString*)message toView:(UIView*)view
{
    ...
    hud.detailsLabel.text = message;
    [self showAnimatedWithImage:[UIImage imageNamed:@"MBProgressHUD.bundle/loading_gray"] toHUD:hud];
...
{
    MBProgressHUD * hud = [self showMessage:message withImage:[UIImage imageNamed:@"MBProgressHUD.bundle/hud-warning"] toView:view];
    return hud;
}

+ (MBProgressHUD*)showSuccessWithMessage:(NSString*)message toView:(UIView*)view
{
    MBProgressHUD * hud = [self showMessage:message withImage:[UIImage imageNamed:@"MBProgressHUD.bundle/hud-success"] toView:view];
    return hud;
}

+ (MBProgressHUD*)showFailWithMessage:(NSString*)message toView:(UIView*)view
{
    MBProgressHUD * hud = [self showMessage:message withImage:[UIImage imageNamed:@"MBProgressHUD.bundle/hud-fail"] toView:view];
    return hud;
}
