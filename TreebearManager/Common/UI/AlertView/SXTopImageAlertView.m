...
#import "SXTopImageAlertView.h"

const CGFloat SXTopImageAlertViewWidthRatio = 0.655;  //宽度系数
const CGFloat SXTopImageAlertViewHeightRatio = 0.206; //高度系统

@interface SXTopImageAlertView ()
...
@implementation SXTopImageAlertView
...
+ (instancetype)alertWithTopImageName:(NSString *)imageName Title:(NSString *)title content:(NSString *)content confirmStr:(NSString *)confirmStr cancelStr:(NSString *)cancelStr{
    SXTopImageAlertView *alert = [[self alloc] initWithFrame:SXDelegateWindow.bounds];
...
- (void)layoutSubviews{
    ...
    //内容宽高
    //    CGFloat contentW = [UIScreen mainScreen].bounds.size.width * SXTopImageAlertViewWidthRatio;
    //    CGFloat contentH = [UIScreen mainScreen].bounds.size.height * SXTopImageAlertViewHeightRatio;
