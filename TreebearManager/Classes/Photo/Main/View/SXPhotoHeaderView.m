...
- (void)setUpUI{
    ...
    [self.confirmBtn setTitleColor:SXColorBlue2 forState:UIControlStateNormal];
    [self.confirmBtn roundViewWithRadius:15.0f borderColor:SXColorBlue2 borderWidth:1.0f];
