//
//  SXHomeReportDetailController.m
//  TreebearManager
//
...
@interface SXHomeReportDetailController ()<UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>
@property (nonatomic, weak) UICollectionView *collectionView;//滚动视图
@end

@implementation SXHomeReportDetailController
...
- (void)setUpUI{
    ...
    self.navigationItem.title = @"周报详情";
